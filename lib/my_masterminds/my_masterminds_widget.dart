...
class MyMastermindsWidget extends StatefulWidget {
  ...
  @override
  MyMastermindsWidgetState createState() =>
      MyMastermindsWidgetState();
}
...
//    _mastermindWidgets = []; // TODO remove after network call
  ...
  Widget _buildEnrolledMasterminds() {
    List<Widget> _mastermindWidgets =
        _buildMastermindPresenter(mockMasterminds);
