...
class ContactFacilitatorWidget extends StatefulWidget {
  ...
  @override
  ContactFacilitatorWidgetState createState() =>
      ContactFacilitatorWidgetState();
}
...
class ContactFacilitatorWidgetState extends State<ContactFacilitatorWidget> {
  void _handleOnPressed() {
    Navigator.push(
      context,
      MaterialPageRoute(
          builder: (context) => QualifyingQuestionWidget(widget.mastermind)),
    );
  }
  ...
  Widget _buildSubtitle() {
    return Container(
        ...
        child: Text('Help your facilitator understand what you hope to get out of the mastermind and what you can bring to it',
            style: TextStyle(
                color: Colors.black,
                letterSpacing: 0.5,
                fontSize: 18.0,
