...
class ReviewAndPayWidgetState extends State<ReviewAndPayWidget> {
  void _handleOnPressed() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => OrderConfirmationWidget(widget.mastermind)),
    );
  }
      ...
      bottomNavigationBar: Container(
        ...
        child: Container(
          ...
          child: MaterialButton(
            ...
            child: Container(
              child: Text('Confirm - \$' + (widget.mastermind.price * 1.17).toStringAsFixed(2),
                  style: TextStyle(
                      color: Colors.white,
                      letterSpacing: 0.5,
                      fontSize: 20.0,
      ...
      children: [
        ...
        Padding(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              Text('\$' + mastermindPrice.toStringAsFixed(2), style: _getTextStyle()),
            ])),
        Padding(
            padding: EdgeInsets.only(top: 16.0),
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              Text('Service Fee', style: _getTextStyle()),
              Text('\$' + servicePrice.toStringAsFixed(2), style: _getTextStyle()),
            ])),
        Padding(
            padding: EdgeInsets.only(top: 16.0),
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              Text('Taxes', style: _getTextStyle()),
              Text('\$' + taxPrice.toStringAsFixed(2), style: _getTextStyle()),
            ])),
        getDivider(),
