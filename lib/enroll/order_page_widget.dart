...
class OrderPageWidgetState extends State<OrderPageWidget> {
  void _handleOnPressed() {
    Navigator.push(
      context,
      MaterialPageRoute(
          builder: (context) => ContactFacilitatorWidget(widget.mastermind)),
    );
  }
                ...
                Row(
                  children: List<Icon>.generate(5, (int index) {
                    return (index + 1 <= _getAverageScore())
                        ? Icon(Icons.star,
                            color: Colors.yellow[500], size: 16.0)
        ...
        Padding(
            ...
            child: Row(
                ...
                children: [
                  ...
                  Text('\$' + mastermindPrice.toInt().toString(),
                      style: _getTextStyle()),
                ])),
        Padding(
            padding: EdgeInsets.only(top: 16.0),
            child: Row(
                ...
                children: [
                  ...
                  Text('\$' + servicePrice.toInt().toString(),
                      style: _getTextStyle()),
                ])),
        Padding(
            padding: EdgeInsets.only(top: 16.0),
